...
module top(clk, rst, uo_out, debug_out, debug_pen, ui_in);
  ...
  wire wr_data_en;
  assign \$1  = ui_in[7:5] == (* src = "/Users/virantha/dev/tinytapeout/tt10-enigma/src/top.py:59" *) 3'h4;
  assign \$2  = result_ready & (* src = "/Users/virantha/dev/tinytapeout/tt10-enigma/src/top.py:59" *) \$1 ;
  (* src = "/Users/virantha/dev/tinytapeout/tt10-enigma/src/top.py:11" *)
  always @(posedge clk)
    \$4  <= \$3 ;
  ...
  assign \inc$29  = inc;
  assign is_ltor = ltor;
  assign \din_sel$33  = din_sel;
  assign \is_at_turnover$35  = is_at_turnover;
