...
module top(clk, rst, uo_out, ui_in);
  ...
  output [5:0] uo_out;
  wire [5:0] uo_out;
  assign \$1  = ui_in[7:5] == (* src = "/Users/virantha/dev/tinytapeout/tt10-enigma/src/top.py:47" *) 3'h4;
  assign \$2  = ready & (* src = "/Users/virantha/dev/tinytapeout/tt10-enigma/src/top.py:47" *) \$1 ;
  (* src = "/Users/virantha/dev/tinytapeout/tt10-enigma/src/top.py:10" *)
  always @(posedge clk)
    \$4  <= \$3 ;
  ...
  \top.r0  r0 (
    ...
    .right_in(ui_in[4:0]),
    .rst(rst),
    .swizz_l_minus_cnt_ring(right_out)
  );
  ...
  \top.r1  r1 (
    ...
    .right_in(\right_in$6 ),
    .rst(rst),
    .swizz_l_minus_cnt_ring(\left_in$17 )
  );
...
(* generator = "Amaranth" *)
module \top.r0 (clk, rst, is_at_turnover, left_out, swizz_l_minus_cnt_ring, left_in, en, load_start, load_ring, inc, right_in);
